...
ifeq ($(PB_ENABLE_DM_VERITY_CHECK),true)
    LOCAL_CFLAGS += -DPB_ENABLE_DM_VERITY_CHECK=$(PB_ENABLE_DM_VERITY_CHECK)
endif

ifeq ($(PB_ENABLE_SKIP_TREBLE_COMP_CHECK),true)
    LOCAL_CFLAGS += -DPB_ENABLE_SKIP_TREBLE_COMP_CHECK=$(PB_ENABLE_SKIP_TREBLE_COMP_CHECK)
endif
ifneq ($(PB_TORCH_MAX_BRIGHTNESS),)
	LOCAL_CFLAGS += -DPB_MAX_BRIGHT_VALUE=\"$(PB_TORCH_BRIGHTNESS_MAX)\"
endif

ifeq ($(PB_ENABLE_PATCH_AVB2_CHECK),true)
    LOCAL_CFLAGS += -DPB_ENABLE_PATCH_AVB2_CHECK=$(PB_ENABLE_PATCH_AVB2_CHECK)
endif
